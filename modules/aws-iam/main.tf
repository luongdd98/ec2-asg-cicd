...
# IAM Policy cho CodeDeploy agent
...
# Attach AWS managed policy cho SSM
...
# Attach AWS managed policy cho CodeDeploy
...
# IAM Role cho CloudWatch Events
...
# IAM Policy cho CloudWatch Events
